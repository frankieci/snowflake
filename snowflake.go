...
/**
 * Created by frankieci on 2020/12/24 6:43 pm
 */
...
func GenInt64ID() int64 {
	return CommonConfig.GenInt64ID2()
}
...
func (c *Config) getCurrentTimestamp() int64 {
	// divided by 2^20 (~10^6, nano to milliseconds)
	return (time.Now().UnixNano() - startEpochNano) >> 20 & c.timeMask
}

// GenInt64ID2 generates unique int64 IDs with the setting in the methond owner
func (c *Config) GenInt64ID2() int64 {
	for {
